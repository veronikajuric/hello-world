		...
		<>
			<SectionWrapper>
				...
				<HeroContentWrapper>
					...
					<Space small />
					<Button color="purple">Get In Touch With Us</Button>
				</HeroContentWrapper>
				<HeroImageWrapper>
					<img
						src="https://fatcatcoders-dev.websupercell.com/static/catsWorking-0ccb17777983b74fd63a5594a8c5401a.png"
					/>
				</HeroImageWrapper>
			</SectionWrapper>
			<SectionWrapper direction="column" gray>
				<Title> Our strongest suits</Title>
				...
				<BulletsWrapper>
					<BulletsContainer>
						<div>
							<Bullet icon={faCheck} />
							<BulletText>E-commerce in Magento</BulletText>
						</div>
						<div>
							<Bullet icon={faCheck} />
							<BulletText>E-commerce in SalesForce Commerce Cloud</BulletText>
						</div>
						<div>
							<Bullet icon={faCheck} />
							<BulletText>Cloud Back-End API Development</BulletText>
						</div>
						<div>
							<Bullet icon={faCheck} />
							<BulletText>Website Development in WordPress</BulletText>
						</div>
					</BulletsContainer>
				</BulletsWrapper>
			</SectionWrapper>
			<SectionWrapper direction="column" align="center">
				...
				<Space small />
				<Button color="purple">See Our Portfolio</Button>
			</SectionWrapper>
			<SectionWrapper gray />
		</>
	);
