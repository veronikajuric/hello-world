			...
			<HeroSection
				...
				description={(
					<>
						...
						<B> powerful tools </B>
						{' '}
						you need to build amazing web applications or find the right talent for your company.
					</>
				)}
				btnText="Let's Work Together"
				image={<img src="https://fatcatcoders-dev.websupercell.com/static/catsChilling-801869febba3b61e562832fd0be50de0.png" />}
			/>
